...
void FluidEmitter2D::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("set_sim_target_path", "path"), &FluidEmitter2D::set_sim_target_path);
	ClassDB::bind_method(D_METHOD("get_sim_target_path"), &FluidEmitter2D::get_sim_target_path);
...
void FluidEmitter2D::set_sim_target_path(const NodePath &v) { _sim_target_path = v; }
NodePath FluidEmitter2D::get_sim_target_path() const { return _sim_target_path; }
